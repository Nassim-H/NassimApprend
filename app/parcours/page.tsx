    ...
    return (
      ...
      <Header />
        <div className="container mx-auto px-4 py-8">
          ...
          <h1 className="text-2xl md:text-3xl font-bold m-4 text-center">Voici mon parcours !</h1>
         </div>
